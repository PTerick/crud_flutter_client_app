...
import '${variables.etoName?lower_case}update/${variables.etoName?lower_case}_update_request_dto.dart';
import '${variables.etoName?lower_case}update/${variables.etoName?lower_case}_update_response_dto.dart';
...
abstract class RestClient {
  ...
  @POST("/${variables.etoName?lower_case}management/{apiVersion}/${variables.etoName?lower_case}/")
  Future<${variables.etoName?cap_first}UpdateResponseDto> update(@Body() ${variables.etoName?cap_first}UpdateRequestDto dto, @Path("apiVersion") String apiVersion);
