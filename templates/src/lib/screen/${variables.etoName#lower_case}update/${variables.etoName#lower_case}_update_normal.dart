...
class ${variables.etoName?cap_first}UpdateNormalView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ScreenState();
}

class _ScreenState
    extends AbstractState<${variables.etoName?cap_first}UpdateBloc, ${variables.etoName?cap_first}UpdateNormalView> {
  ...
  Widget buildWidget(BuildContext buildContext, AbstractBlocState state) {
    ...
    return PlatformScaffold(
        ...
        appBar: PlatformAppBar(
          ...
          title: Text("Update ${variables.etoName?cap_first}"),
        ),
        body: Center(
