...
class ${variables.etoName?cap_first}InsertNormalView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ScreenState();
}

class _ScreenState
    extends AbstractState<${variables.etoName?cap_first}InsertBloc, ${variables.etoName?cap_first}InsertNormalView> {
