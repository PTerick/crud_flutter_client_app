...
class ${variables.etoName?cap_first}ListNormalView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ScreenState();
}

class _ScreenState
    extends AbstractState<${variables.etoName?cap_first}ListBloc, ${variables.etoName?cap_first}ListNormalView> {
  List<${variables.etoName?cap_first}ListContentResponseDto>? _list;
    ...
    return  Card(
        child: ListTile(
          ...
          trailing: InkWell(
            ...
            onTap: () => {
              Navigator.pushNamed(context, "/${variables.etoName?lower_case}UpdateScreen",
                  arguments: item),
