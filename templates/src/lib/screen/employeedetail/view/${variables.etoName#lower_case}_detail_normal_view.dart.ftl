...
import 'package:devon4ng_flutter_application_template/model/${variables.etoName?lower_case}detail/${variables.etoName?lower_case}_detail_bloc.dart';
...
class {variables.etoName?cap_first}DetailNormalView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ScreenState();
}

class _ScreenState
    extends AbstractState<{variables.etoName?cap_first}DetailBloc, {variables.etoName?cap_first}DetailNormalView> {
